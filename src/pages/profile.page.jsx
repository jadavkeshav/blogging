...
const ProfilePage = () => {
    ...
    let { personal_info: { fullname, bio, username: profile_username, profile_img }, account_info: { total_reads, total_posts }, social_links, joinedAt } = profile;
                    ...
                    profile_username.length ?
                        <section className="h-cover md:flex flex-row-reverse items-start gap-5 min-[1100px]:gap-12" >
                            <div className="flex flex-col max-md:items-center gap-5 min-w-[250px] md:w-[50%] md:pl-8 md:border-l border-grey md:sticky md:top-[100px] md:py-10 ">
                                <img src={profile_img} alt="profile" className="w-48 h-48 rounded-full md:w-32 md:h-32 " />
