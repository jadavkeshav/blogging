...
const EditProfile = () => {
                    ...
                    if (url) {
                        axios.post(import.meta.env.VITE_SERVER_DOMAIN + "/update-profile-img", { url }, {
                            ...
                            .then(({ data }) => {
                                ...
                                storeIsSession("user", JSON.stringify(newUserAuth));
    ...
    console.log("social_links", Object.keys(social_links))
                    ...
                    <form ref={editProfileForm} >
                        ...
                        <div className="flex flex-col lg:flex-row items-start py-10 gap-8 lg:gap-10   ">
                            ...
                            <div className="w-full">
                                ...
                                <p className="text-dark-grey -mt-3" >Username will be used to search for user and will be visible to all users.</p>

                                <textarea name="bio" maxLength={bioLimit} defaultValue={bio} placeholder="Bio" className="input-box h-64 lg:h-40 resize-none leading-7 mt-5 pl-5 " onChange={handleCharacterChange}></textarea>
