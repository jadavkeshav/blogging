        ...
        <>
            ...
            <div className="flex gap-6 justify-between ">
                <div className="flex gap-3 items-center">
                    <button onClick={handleLike} className={"w-10 h-10 rounded-full flex items-center justify-center  " + (islikedByUser ? "bg-red/20 text-red" : "bg-grey/80 hover:bg-grey/30")} >
                    ...
                    className="w-10 h-10 rounded-full flex items-center justify-center bg-grey/80 hover:bg-grey/30" 
                    >
                ...
                <div className="flex gap-6 items-center ">
                    ...
                    {
                        username === author_username ? <Link to={`/editor/${blog_id}`} ><i className="fi fi-rr-edit text-xl hover:text-purple"></i></Link> : " "
                    }
